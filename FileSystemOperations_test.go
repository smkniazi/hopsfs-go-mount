...
func withMount(t testing.TB, srcDir string, fn func(mntPath string, hdfsAccessor HdfsAccessor)) {
	...
	hdfsAccessor, _ := NewHdfsAccessor("rpc.namenode.service.consul:8020", WallClock{}, TLSConfig{TLS: true, RootCABundle: rootCABundle, ClientCertificate: clientCertificate, ClientKey: clientKey})
